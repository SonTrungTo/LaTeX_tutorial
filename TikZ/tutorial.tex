...
We are working on
  \begin{tikzpicture}[scale=3]
    ...
    \draw[->] (0,-1.5)--(0,1.5) coordinate (y axis); %Now add the half circle
    \draw (0,0) circle [radius=1cm];
    \shadedraw[left color=gray,right color=green,draw=green!50!black] (0,0)--(3mm,0mm)
      arc [start angle=0, end angle=30, radius=3mm]--cycle;
    % \filldraw[fill=green!20!white, draw=green!50!black] (0,0)--(3mm,0mm)
    %   arc [start angle=0, end angle=30, radius=3mm]--cycle;
    \draw[red, very thick] (30:1cm) -- node[left=1pt,fill=white]{$\sin \alpha$}  (30:1cm |- x axis); %+(0,-0.5);
    \draw[blue, very thick] (30:1cm |- 0,0) -- node[below=2pt,fill=white]{$\cos \alpha$} (0,0); %(30:1cm) ++(0,-0.5) -- (0,0);
