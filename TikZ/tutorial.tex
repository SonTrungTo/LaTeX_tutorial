...
\usetikzlibrary{mindmap, calendar, backgrounds, trees} %SECTION 6
...
\begin{tikzpicture}[text width=2.7cm, align=flush center, grow cyclic,
  ...
  level 2/.style={level distance=3cm, text width=2cm, font=\footnotesize, sibling angle=30}]
  \node[font=\bfseries] {Computational Complexity}
